...
CREATE TABLE `db_config` (
  ...
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '连接池',
...
INSERT INTO `db_config` VALUES (1,'a','com.zaxxer.hikari.HikariDataSource','com.mysql.cj.jdbc.Driver','jdbc:mysql://127.0.0.1:3306/dd_a?useSSL=false&serverTimezone=GMT%2B8','root','123');
INSERT INTO `db_config` VALUES (2,'b','com.zaxxer.hikari.HikariDataSource','com.mysql.cj.jdbc.Driver','jdbc:mysql://127.0.0.1:3306/dd_b?useSSL=false&serverTimezone=GMT%2B8','root','123');
